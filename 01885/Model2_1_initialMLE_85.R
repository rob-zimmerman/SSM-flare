...
pars.t <- optimParallel(par=c(2.2, -2.3, -1.87, -1.70, -2.85),
...
preds.hist <- ggplot(data.frame(x=X1.hat), aes(x=x)) + 
  ...
  annotate("label", label="ObsID 01885", y=420, x=2.3, size=11/.pt, family="Times New Roman") +
...
preds.hist
ggsave(file=paste0(getwd(),"/Figures/EVLac_85_M2_predshist_soft.png"), preds.hist, height=3, width=7)
